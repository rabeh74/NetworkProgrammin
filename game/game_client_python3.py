...
# frame for the name and connect button widgets
...
# frame for the messages and entry field (welcome message from server )
...
# frame fro me and opponent name and score
...
# frame for the game round and timer
...
# frame for the middle section of the GUI (rock, paper, scissors)
